...
/* SatoGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 16;

static const bool DEFAULT_SATOASHSCREEN = true;
...
/* Color of labels */
#define COLOR_LABELS QColor("#0366c9")

/** LIGHT MODE */
/* Background color, very light gray */
#define COLOR_BACKGROUND_LIGHT QColor("#fbfbfe")
/* Sato dark orange */
#define COLOR_DARK_ORANGE QColor("#4f9ce5")
/* Sato light orange */
#define COLOR_LIGHT_ORANGE QColor("#024d97")
/* Sato dark blue */
#define COLOR_DARK_BLUE QColor("#024d97")
/* Sato light blue */
#define COLOR_LIGHT_BLUE QColor("#4f9ce5")
/* Sato asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* Sato shadow color - light mode */
...
/* Sato shadow color - dark mode */
#define COLOR_SHADOW_DARK QColor("#0c1b3d")
/* Sato Light blue - dark mode - dark mode */
#define COLOR_LIGHT_BLUE_DARK QColor("#1e2636")
/* Sato Dark blue - dark mode - dark mode */
#define COLOR_DARK_BLUE_DARK QColor("#0b1018")
/* Pricing widget background color */
#define COLOR_PRICING_WIDGET QColor("#161e2d")
/* Sato dark mode administrator background color */
#define COLOR_ADMIN_CARD_DARK COLOR_BLACK
/* Sato dark mode regular asset background color */
#define COLOR_REGULAR_CARD_DARK_BLUE_DARK_MODE QColor("#024d97")
/* Sato dark mode regular asset background color */
#define COLOR_REGULAR_CARD_LIGHT_BLUE_DARK_MODE QColor("#4f9ce5")
/* Toolbar not selected text color */
#define COLOR_TOOLBAR_NOT_SELECTED_TEXT_DARK_MODE COLOR_WHITE
/* Toolbar selected text color */
#define COLOR_TOOLBAR_SELECTED_TEXT_DARK_MODE QColor("#c5ccdf")


/* Sato label color as a string */
#define STRING_LABEL_COLOR "color: #0366c9"
